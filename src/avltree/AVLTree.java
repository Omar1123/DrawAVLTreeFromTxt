...
/************
	...
	static class Main extends JFrame implements ActionListener{
            ...
            private File FILENAME = new File("/Users/jake/NetBeansProjects/AVLTree/src/avltree/load.txt");
		...
		public Main(){                                                 
			...
			panel1 = new JPanel();
                        /*************buttons******/
			button0 = new JButton("Cargar arbol AVL"); 
			//button1 = new JButton("");
			//button2 = new JButton("");
			button3 = new JButton("Mostrar arbol AVL");
		...
		public void actionPerformed(ActionEvent e){		
			if (e.getSource() == button0){
                            ...
                            String s=JOptionPane.showInputDialog("Desea ingresar el arbol AVL(1: Si)");
                            ...
                            try {
                                ...
                                while((lines = buffer.readLine())!=null) {                
                                    ...
                                    B.insert(Integer.parseInt(lines),B.root);
                                }
